...
UI.prototype.addQuestion = function(element, question){
  ...
  <div class="flashcard-btn d-flex justify-content-between">
   ...
   data-id="${question.id}">edit</a>
   <a href="#" id="delete-flashcard" data-id="${question.id}" class="btn my-1 delete-flashcard text-uppercase">
   delete</a>
  </div>
 </div>`;
...
document.addEventListener('DOMContentLoaded',function(){
  // calling function on loading page
  eventlisteners();
});